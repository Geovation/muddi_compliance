...
ALTER ROLE postgres SET search_path TO nuarcodelists_datamanagement,nuarcodelists_platform,nuarcodelists_transformation,nuarcustombackdrop,nuardata,nuarorganisations,nuarsubmissions,nuarusercreateddata,nuarversion,public;
...
CREATE TABLE nuardata.archaeologicalsite (
   ...
   datasensitivitylevel text DEFAULT 'Requires Redaction',
